...
This is a guide on how to connect Jupyter notebook from ubuntu remote server at local side. The system of local machine is windows10.Please click the following link to find the original blog.
